...
<form action="{{ route('song.store') }}" enctype='multipart/form-data' method="post">
...
@endif
    ...
    <input type="file" name="video" id="Myvideo">
        ...
        <div class="col-md-12 ">
            ...
            <select class="livesearch form-control p-3" name="artist_id"></select>
        </div>
        <div class="col-md-12 ">
            <label for="featureName">Featured Artists</label>
            <select class="featuresearch form-control p-3" name="featuring[]" multiple="multiple"></select>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <label for="CatgoryName">Category</label>
            <select class="catsearch form-control p-3" name="category_id"> </select>
        </div>
        <div class="col-md-12">
    ...
    $('.featuresearch').select2({
        ...
        ajax: {
            ...
            processResults: function (data) {
                ...
                $("input[name='featuring']").val(artdata);
            },
            cache: true
        }
    });
