...
<div class="Catgory-section">
    <div class="left-Catgory-section">
        ...
        // die; 
        ?>
<form action="{{ route('update_song',$song_data->id) }}" enctype='multipart/form-data' method="post">
  ...
  <source src="{{url('')}}/storage/song/{{$song_data->song}}" type="audio/ogg">
    ...
    <div class="col-md-12 ">
        ...
        <div class="col-md-12">
            ...
            <select class="featuresearch form-control p-3" name="featuring[]" multiple="multiple" value="{{$song_data->featuring}}"></select>
        </div>
        <div class="col-md-12 ">
        Featured Artists Name: {{$feature_artist_id_data}} 
        </div>
		<div class="col-md-12">
