...
Route::post('episode_played_date_store', 'App\Http\Controllers\api\PodcastController@episode_played_date_store');
Route::get('privacy_policy', 'App\Http\Controllers\api\AuthController@privacy_policy');
Route::get('terms_conditions', 'App\Http\Controllers\api\AuthController@terms_conditions');
Route::post('contact_us', 'App\Http\Controllers\api\AuthController@contact_us');
Route::post('verify_contact', 'App\Http\Controllers\api\AuthController@verification');
...
Route::group([
    ...
    */
    ...
    //Route::post('admin-panel', 'App\Http\Controllers\api\AuthController@admin-panel');
    ...
    */
    ...
    Route::get('users_visit_listing', [AdController::class, 'users_visit_listing'])->name('users_visit_listing');
  ...
  */
    ...
    */
     ...
     Route::get('terms_conditions', [searchdataController::class, 'terms_conditions']);
    // Route::post('terms_conditions', 'App\Http\Controllers\api\searchdataController@terms_conditions');
